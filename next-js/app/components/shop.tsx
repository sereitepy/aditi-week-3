              ...
              <div className='w-65 flex-wrap'>
                ...
                <div className='p-3 flex flex-col gap-3 peer w-65'>
                  <div className='flex justify-between gap-3'>
                    <h1 className='flex flex-wrap font-semibold'>
                      {product.title}
                    </h1>
